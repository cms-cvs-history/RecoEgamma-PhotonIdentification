...
PhotonIDProd = cms.EDProducer("PhotonIDProducer",
    ...
    LooseEMHadOverEMEB = cms.double(0.5),
    ...
    LoosePhotonHadOverEMEB = cms.double(0.5),
    ...
    TightPhotonHadOverEMEB = cms.double(0.5),
    ...
    LooseEMHadOverEMEE = cms.double(0.5),
    ...
    TightPhotonHadOverEMEE = cms.double(0.5),
